...
def network(input_var, label_var, shape):
    ...
    layer = nn.layers.Conv2DLayer(layer, num_filters = 32,filter_size = 3,
    ...
    layer = nn.layers.Conv2DLayer(layer, num_filters = 64,filter_size = 3,
    ...
    #convolutional layers with 'full' pad
    layer = nn.layers.Conv2DLayer(layer, num_filters = 32,filter_size = 3,
                                  nonlinearity = nn.nonlinearities.rectify, pad = 'full') #114 
